...
{
    public class MintCollateralToken : IRunnableExample
    {
        ...
        public async void Run()
        {
            ...
            // refresh the reserve and deposit reserve liquidity in exchange for cTokens!
            txBuilder
                .AddInstruction(Solend.RefreshReserve(
                    new(reservePubkey),
                    reserve.Liquidity.PythOracle,
                    reserve.Liquidity.SwitchboardOracle))
                .AddInstruction(Solend.DepositReserveLiquidity(
                    nativeDepositAmount,
                    liquidityAta,
                    collateralAta,
                    new(reservePubkey),
